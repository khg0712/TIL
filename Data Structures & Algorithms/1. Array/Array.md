...
function WordList(arr) {
    this.arr = arr;
    this.reversePrintAll = reverseAll;
    this.printAll = showAll
}
...
const myWordList = new WordList(["abc","def","geh"]);
myWordList.printAll();
myWordList.reversePrintAll();
```
...
console.log(myWeeklyTemp.getAllWeeklyAvg());//[ 2.5, 8.5, 14.5, 20.5 ]
console.log(myWeeklyTemp.getMonthlyAvg());//11.5
console.log(myWeeklyTemp.getWeeklyAvg(2));//8.5
```